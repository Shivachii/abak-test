    ...
    <section className="max-w-6xl mx-auto">
      <div className=" px-4 py-8">
        ...
        <p className="text-lg mb-8 text-justify mt-4 text-gray-600 max-w-2xl mx-auto">
          Welcome to our Media Galleries – a curated collection of images,
          videos and documents showcasing our events, initiatives, and impact.
          Explore each gallery to get a visual glimpse into our work and
          community stories.
        </p>
